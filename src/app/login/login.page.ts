...
export class LoginPage implements OnInit {
  ...
  langs: string[] = [];
  constructor(private servicio: FirebaseService,private authServ: AlumnosService, private toastCtrl: ToastController,private router: Router, private translateService: TranslateService) { 
